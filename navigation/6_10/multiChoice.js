...
var cookieJSON;
var myCookieName ='ccTAMex6_10';
var cookieLifetime = 365;
var cookieSavedNo=0;
var dimensions = [[[468, 174],[323, 131],[458, 219],[545, 160],[245, 63]]];
var foundThem=[];
var foundAll;
...
function readJSON() {
	...
	for (i=0;i<exItems.length;i++)
	{
		...
		for (j=0;j<y.length;j++)
		{
			...
			theJSONElements += ' class="hideMe" />'+'<span'+' onclick=checkAnswersTxt(this)><div class="invisible">'+ y[j]+'</div><img class="mymark '+markCorrClass+'" src="../../images/corr.png" width="30" height="30"><img class="mymark '+markWronClass+'"  width="'+dimensions[i][j][0]+'" height="'+dimensions[i][j][1]+'"><img class="mymark" src="'+'phrase'+i+'_'+j+'.png" width="'+dimensions[i][j][0]+'" height="'+dimensions[i][j][1]+'"></span>'+'</li>';
