...
function readJSON() {
	...
	for (i=0;i<exItems.length;i++)
	{
		...
		theJSONElements += '> <div id="sheme"><img src="sheme.png" alt="Sheme image" name="shemeImg" /></div> <div class="stem">' + w + '</div><br>'+'<ul>';
...
function phrasesAppear(){
	...
	$("#sheme").removeClass('hideMe');
	$("#sheme").addClass('animated bounceInUp');
}
